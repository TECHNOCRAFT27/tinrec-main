        ...
        <div>
            ...
            <section  className="hero-section text-center">
                ...
                <div className="mt-4">
                    {!isAuthenticated ? (
                        <>
                            <Button variant="contained" component={Link} to="/signup" className="cta-btn">Get Started</Button>
                        </>
                    ) : (
                ...
                <div className="row">
                    <div className="col-md-4">
                        <div className="feature-box">
                            <img src="https://www.freepnglogos.com/uploads/recycle-png/recycle-png-transparent-image-pngpix-5.png" alt="Recycle" />
                    ...
                    <div className="col-md-4">
                        <div className="feature-box">
                            <img src="https://www.peakscientific.com/media/owod4i2o/website-icons-transparent_24-hours-18.png" alt="Convenience" />
                            <h4>Easy Pickup</h4>
                    ...
                    <div className="col-md-4">
                        <div className="feature-box">
                            <img src="https://www.pngmart.com/files/7/Earn-PNG-Transparent-Image.png" alt="Rewards" />
                            <h4>Get Rewarded</h4>
