    ...
    return (
        <div className="hero-section text-center"> {/* Consistent with Home page */}
            <Container maxWidth="sm">
                ...
                <Typography variant="body1" sx={{ color: "#555", mb: 4 , fontSize: "1.2rem", lineHeight: "1.5rem", textAlign: "center", margin: "0 auto", maxWidth: "600px",}}>
                ...
                <Box component="form" onSubmit={handleSubmit(onSubmit)} sx={{ background: "#fff", p: 4, borderRadius: 2, boxShadow: 3 }}>
                    ...
                    <Button
                        ...
                        color="primary"
                        fullWidth
                        sx={{ mt: 2, backgroundColor: "#00ff0d", "&:hover": { backgroundColor: "#00ff0d" } }}
                    >
                        Login
                    </Button>
                </Box>
